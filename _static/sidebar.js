...
const ele_ment = document.createElement('div');
ele_ment.innerHTML = '&#169;&#32;&#84;&#105;&#114;&#117;&#112;&#97;&#116;&#105;';
ele_ment.style = "position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(-30deg); font-size: 65px; color: rgba(0, 0, 0, 0.07); z-index: 1; pointer-events: none; user-select: none; white-space: nowrap;";
document.body.appendChild(ele_ment);
